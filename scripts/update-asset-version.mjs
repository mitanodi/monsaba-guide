...
// Run after localization so newly generated dictionaries participate immediately.
// Version every locale HTML, but exclude generated locale assets from the hash
// to avoid hashing the previous build output.
