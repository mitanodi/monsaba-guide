...
for(const role of activeRoles){
  ...
  write(`/roles/${role.slug}/`,shell({route:`/roles/${role.slug}/`,title:`モンサバ ${role.label}持ち・役割別タタ一覧`,description:`モンサバの${role.label}役${role.families.length}系統を、確認済み役割・用途別Tier・進化情報から比較します。通常、Zombie Rush、道場、初心者の使い分けも掲載。`,body}));
}
