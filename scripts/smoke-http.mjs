...
const routes = ['/', '/beginner-guide/', '/about/', '/search/', '/updates/', '/privacy/', '/about-data/', '/consult/', '/tata-tier/', '/evolution-priority/', '/zombie-rush/', '/boss-rally/', '/badge-dojo/', '/normal-guide/', '/attribute/grass/', '/attribute/water/', '/attribute/fire/', '/attribute/thunder/', '/attribute/rock/', ...tatari.families.map((family) => `/tata/${family.id}/`)];
