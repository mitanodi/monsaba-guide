...
const faqs = [
  ...
  ['ゾンビラッシュ専用変更は総合Tierに影響する？', '専用変更だけを理由に総合Tierを自動変更しません。Season 1開始後に実戦を確認し、モードごとの評価を再検討します。', '/zombie-rush/', 'ゾンビラッシュの注意を見る']
  ...
  ,['ゾンビラッシュで属性オーラは効く？', '現在の確認済み情報では、第4進化の属性オーラはゾンビラッシュでは無効として扱っています。専用Lv3・Lv5・Lv7スキルや基礎性能を重視します。', '/zombie-rush/', 'ゾンビラッシュ攻略を見る']
...
const faqDescription = 'モンサバの進化、属性育成、2体比較、Tierの見方、ゾンビラッシュ専用変更について、確認済みデータに基づく短い回答をまとめます。';
