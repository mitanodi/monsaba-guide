...
const replacements = {
  'updates/index.html': [
    ...
    ['ゾンビラッシュSeason 1、チップ調整、専用スキル35体の予定値', 'ゾンビラッシュ Season 1、チップ調整、専用スキル35体の公式告知値'],
    ['専用スキルを通常スキルDBから分離し、総合Tierは変更していません', 'ゲーム内で未確認の詳細は確認待ちとして分離しています'],
    ['8/26アップデート予定を詳しく見る', '8/26アップデート実装内容を見る']
  ],
  'zombie-rush/index.html': [
    ['"description":"モンサバのゾンビラッシュ攻略。現在の実戦Tierとは別に、2026年8月26日Season 1実装前の専用スキル・チップ変更をもとにしたAI予測Tierと採用率予測を掲載。"', '"description":"モンサバのゾンビラッシュ Season 1攻略。実戦Tierの確認状況、旧環境Tier、8月25日に保存したAI予測Tierと答え合わせを分離して掲載。"']
  ],
  'events/treasure-hunt/index.html': [
    ...
    ['<meta property="og:url" content="https://monster-survival.com/events/treasure-hunt/">', '<meta property="og:url" content="https://monster-survival.com/events/treasure-hunt/"><meta name="twitter:card" content="summary"><meta name="twitter:title" content="モンサバ お宝探しソルバー"><meta name="twitter:description" content="残り配置候補から各マスの宝確率とおすすめマスを計算。">'],
    ['形を押すたびに1個追加します（各形状3個まで）。幅×高さの向きは別々に扱います。', '形を押すたびに1個追加します（各形状8個まで）。長方形のお宝は縦・横どちらの向きも自動で計算します。1×2と2×1は同じお宝として扱います。'],
    ['形を押すたびに1個追加します（各形状3個まで）。長方形のお宝は縦・横どちらの向きも自動で計算します。1×2と2×1は同じお宝として扱います。', '形を押すたびに1個追加します（各形状8個まで）。長方形のお宝は縦・横どちらの向きも自動で計算します。1×2と2×1は同じお宝として扱います。'],
